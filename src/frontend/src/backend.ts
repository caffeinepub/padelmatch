...
export class Backend implements backendInterface {
    ...
    async discoverCandidates(arg0: Filters): Promise<Array<Profile>> {
        if (this.processError) {
            try {
    ...
    async uploadPhoto(arg0: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadPhoto(await to_candid_ExternalBlob_n30(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "drive" in value ? Position.drive : "reves" in value ? Position.reves : value;
}
